                ...
                <div class="col-tact-stye-one col-lg-12 mb-md-50">
                    ...
                    <div class="contact-form-style-one">
                        <div class="pull-right">
                            <a href="add_team.php" class="link-btn">Add Team</a>
                        </div>
                        <?php

                        $sql = "SELECT id, position, fullname, added_on FROM team ORDER BY id DESC";
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            while ($row = $result->fetch_assoc()) {
                                $id = $row['id']; // Store postid for easy reference
                                echo "<tbody>
                                    <tr>
                                      ...
                                      <td>{$row['added_on']}</td>
                                      <td>
                                          <a href='update_team.php?id={$id}' class='text-secondary'><i class='fa fa-edit'></i></a>
                                          <button type='submit' name='delete' value='{$id}' style='padding: 0px 8px;'><i class='fa fa-trash'></i></button>
                                      </td>
                                    </tr>
                                </tbody>";
                            }
