  ...
  if (filter_var($email, FILTER_VALIDATE_EMAIL) && !empty($pass)) {
    ...
    if ($result->num_rows > 0) {
      ...
      if (password_verify($pass, $row['pass'])) {
        ...
        // Invalid password
        $msg = "<div class='alert-danger'>Invalid email or password.";
      }
    } else {
      // Invalid email
      $msg = "<div class='alert-danger'>Invalid email or password. Ok</div>";
    }
    $stmt->close();
  } else {
    $msg = "<div class='alert-danger'>Please enter a valid email and password.</div>";
  }
}
      ...
      <div class="col-lg-8 offset-lg-2">
        <div class="col-tact-stye-one col-lg-7 mb-md-50">
          <div class="contact-form-style-one">
            <h5 class="sub-title">Back Office</h5>
            <?php echo $msg ?? ''; ?>
